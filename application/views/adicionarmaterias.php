    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Adicionar Matérias</h1>
                    </div>
                                <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="<?php echo base_url('index.php/Materias/adicionarMateria')?>">
                                        <div class="form-group">
                                            ...
                                            <label required="">Nome da Matéria</label>
                                            <input class="form-control" required="" name="nomemateria">
                                            <label>Semestre</label>
                                            <input type="number" max="10" min="1" required="" class="form-control" name="semestre">
                                            <br>
                                            <div class="col-lg-3">
                                            ...
                                            <?php                                    
                                                ...
                                                ?>
                                                <?php 
                                                    if (isset($sucesso_materia)) {
                                                        echo "<div class='alert alert-success' role='alert'>";
                                                        echo $sucesso_materia;
                                                        echo "</div>";
                                                        unset($sucesso_materia);
                                                    }
                                            ?>
                                            </div>
                                        </div>
